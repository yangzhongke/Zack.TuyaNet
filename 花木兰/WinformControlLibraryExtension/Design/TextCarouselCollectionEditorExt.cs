...
{
    /// <summary>
    ///  TextCarousel集合属性编辑窗口扩展(显示帮助文本)
    /// </summary>
    [Description("TextCarousel集合属性编辑窗口扩展(显示帮助文本)")]
    public class TextCarouselCollectionEditorExt : CollectionEditor
    {
        public TextCarouselCollectionEditorExt(Type type) : base(type)
        {
