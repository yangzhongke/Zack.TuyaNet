...
namespace WinformControlLibraryExtension.Design
{
    ...
    /// MenuExt控件设计模式行为
    /// </summary>
    [Description("MenuExt控件设计模式行为")]
    public class MenuExtEditor : ControlDesigner
    {
        ...
        {
            SlideMenuExt control = (SlideMenuExt)this.Control;
        ...
        public override SelectionRules SelectionRules
        {
            get
            {
                return SelectionRules.Moveable | SelectionRules.BottomSizeable | SelectionRules.TopSizeable;
            }
        }
