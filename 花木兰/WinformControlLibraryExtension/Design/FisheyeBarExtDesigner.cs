...
{
    /// <summary>
    /// FisheyeBarExt控件设计模式行为
    /// </summary>
    [Description("FisheyeBarExt控件设计模式行为")]
    public class FisheyeMenuExtDesigner : DottedLineBorderExtDesigner
    {
        ...
        {
            FisheyeMenuExt _control = (FisheyeMenuExt)this.Control;
